            ...
            <div className="w-80 bg-white border-r border-gray-200 p-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-xs text-blue-800">
                        You can upload multiple documents at once. Our AI will automatically categorize and extract
            ...
            <div className="flex-1 p-8 max-w-4xl">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-lg">
                        Upload tax documents using our drag-and-drop interface. Supports PDF, JPG, PNG, and TIFF
                        formats.
                    </p>
                </div>
                        ...
                        <CardContent>
                            <ul className="space-y-2">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>
                                        <strong>JPG/JPEG</strong> - Joint Photographic Experts Group
                                    </span>
                                </li>
                                <li className="flex items-center space-x-2">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>
                                        <strong>TIFF</strong> - Tagged Image File Format
                                    </span>
                                </li>
                            </ul>
                        </CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <strong>Upload method:</strong> Drag & drop or click to select
                                </li>
                                <li>
                                    <strong>Preview:</strong> Available for image files
                                </li>
                                <li>
                                    <strong>Processing:</strong> Automatic upon upload
                                </li>
                            </ul>
                        </CardContent>
                    </Card>
