                ...
                <div className="container mx-auto py-8">
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto">
                            Experience our advanced AI-powered tax assistant with specialized features for tax
                            professionals and individuals. This comprehensive chat interface includes document analysis,
                            tax calculations, form guidance, and enterprise-grade security features.
                        </p>
                    </div>
