        ...
        <div className="space-y-6">
            <div className="mb-8 text-center">
                ...
                <p className="text-lg text-gray-600 max-w-4xl mx-auto">
                    Experience our advanced AI-powered tax assistant with specialized features for tax professionals and
                    individuals. This comprehensive chat interface includes document analysis, tax calculations, form
                    guidance, and enterprise-grade security features.
                </p>
            </div>
            ...
            <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                    ...
                    <div className="text-sm text-purple-800 space-y-2">
                        ...
                        <p>
                            <strong>Common Tax Documents:</strong>
                        </p>
                        <ul className="space-y-1">
