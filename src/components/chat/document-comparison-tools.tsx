...
export default function DocumentComparisonTools({
    ...
    const getHighlightStyle = (highlight: DocumentHighlight) => {
        ...
        return {
            ...
            border: isSelected
                ? '2px solid #3b82f6'
                : `2px solid ${category?.color.includes('green') ? '#22c55e' : '#6366f1'}`,
            borderRadius: '4px',
            cursor: 'pointer',
    ...
    const filteredHighlights1 =
        selectedCategory === 'all' ? highlights1 : highlights1.filter((h) => h.category === selectedCategory)

    const filteredHighlights2 =
        selectedCategory === 'all' ? highlights2 : highlights2.filter((h) => h.category === selectedCategory)
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-7xl max-h-[95vh] overflow-hidden">
                <DialogHeader>
                    ...
                    <DialogDescription>Compare tax documents and highlight important information</DialogDescription>
                </DialogHeader>
                                ...
                                <div className="grid grid-cols-2 gap-4 h-full p-4">
                                    ...
                                    <Card className="h-full">
                                        ...
                                        <CardContent className="h-full overflow-hidden">
                                            <div
                                                ref={doc1Ref}
                                                className="relative bg-gray-50 border rounded-lg h-96 overflow-auto"
                                            >
                                                ...
                                                <div className="p-4 text-sm">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div>
                                                            Employee: <span className="font-medium">John A. Smith</span>
                                                        </div>
                                                        <div>
                                                            SSN: <span className="font-medium">***-**-6789</span>
                                                        </div>
                                                        <div>
                                                            Employer:{' '}
                                                            <span className="font-medium">ABC Manufacturing Corp</span>
                                                        </div>
                                                        <div>
                                                            EIN: <span className="font-medium">12-3456789</span>
                                                        </div>
                                                        <div className="mt-4">
                                                            <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <span className="font-bold">$8,250.00</span>
                                                            </div>
                                                            <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <span className="font-bold">$4,650.00</span>
                                                            </div>
                                                            <div>
                                                                Medicare wages:{' '}
                                                                <span className="font-bold">$75,000.00</span>
                                                            ...
                                                            <div>
                                                                ...
                                                                <span className="font-bold">$1,087.50</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div className="p-4 text-sm">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div>
                                                            Recipient:{' '}
                                                            <span className="font-medium">John A. Smith</span>
                                                        </div>
                                                        <div>
                                                            TIN: <span className="font-medium">***-**-6789</span>
                                                        </div>
                                                        <div>
                                                            Payer:{' '}
                                                            <span className="font-medium">XYZ Consulting Services</span>
                                                        </div>
                                                        <div>
                                                            TIN: <span className="font-medium">98-7654321</span>
                                                        </div>
                                                        <div className="mt-4">
                                                            <div>
                                            ...
                                            <>
                                                ...
                                                <div className="space-y-3">
                                                    {comparisons.map((comparison, index) => (
                                                        <Card
                                                            key={index}
                                                            className={`${!comparison.match ? 'border-yellow-200 bg-yellow-50' : ''}`}
                                                        >
                                                            <CardContent className="p-4">
                                                                <div className="flex items-start justify-between">
                                                                    ...
                                                                    <Badge
                                                                        variant={
                                                                            comparison.match ? 'default' : 'destructive'
                                                                        }
                                                                    >
                                    ...
                                    <div className="p-4 space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                                            {HIGHLIGHT_CATEGORIES.map((category) => (
                                                <div
                                                    key={category.value}
                                                    className={`p-3 border rounded-lg ${category.color}`}
                                                >
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <Card>
                                                ...
                                                <CardContent>
                                                    <div className="space-y-2">
                                                        {filteredHighlights1.map((highlight) => {
                                                            const category = HIGHLIGHT_CATEGORIES.find(
                                                                (c) => c.value === highlight.category
                                                            )
                                                            return (
                                                                <div
                                                                    key={highlight.id}
