...
export default function FormGenerationWorkflow({
    ...
    const [generationSteps, setGenerationSteps] = useState<GenerationStep[]>([
        ...
        },
        {
            ...
            details: ['Populating template fields', 'Generating form document', 'Creating submission package'],
        },
    ])
        ...
        try {
            ...
            for (let i = 0; i < generationSteps.length; i++) {
                setGenerationSteps((prev) =>
                    prev.map((step, index) => (index === i ? { ...step, status: 'processing', progress: 0 } : step))
                )
        ...
        <div className="max-w-6xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Select a template, configure data, and generate your tax form</p>
                </div>
                ...
                <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-4">
                            <Badge variant={currentStep === 'template' ? 'default' : 'secondary'}>1. Template</Badge>
                            <ArrowRight className="h-4 w-4 text-gray-400" />
                            <Badge variant={currentStep === 'configure' ? 'default' : 'secondary'}>2. Configure</Badge>
                            <ArrowRight className="h-4 w-4 text-gray-400" />
                            <Badge variant={currentStep === 'generate' ? 'default' : 'secondary'}>3. Generate</Badge>
                            <ArrowRight className="h-4 w-4 text-gray-400" />
                            <Badge variant={currentStep === 'complete' ? 'default' : 'secondary'}>4. Complete</Badge>
                        </div>
                    </div>
            ...
            {currentStep === 'template' && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Choose the appropriate tax form template for generation</CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            {currentStep === 'configure' && selectedTemplate && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Configure the form generation settings and client data</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex justify-end space-x-2">
                            ...
                            >
                                {generateFormMutation.isPending && <Loader2 className="w-4 h-4 mr-2 animate-spin" />}
                                Generate Form
                            </Button>
                        </div>
                    </CardContent>
            ...
            {currentStep === 'generate' && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Processing your form generation request</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
            ...
            {currentStep === 'complete' && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Your tax form has been successfully generated</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="text-center py-6">
                            <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
                            <h3 className="text-lg font-semibold mb-2">Success!</h3>
                            <p className="text-gray-600 mb-6">Your form has been generated and is ready for review</p>
