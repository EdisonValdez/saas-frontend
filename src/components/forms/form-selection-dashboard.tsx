...
export default function FormSelectionDashboard() {
    ...
    const recentlyUsedForms = useMemo(() => forms.filter((form) => form.isRecentlyUsed).slice(0, 5), [forms])

    const recommendedForms = useMemo(() => forms.filter((form) => form.isRecommended).slice(0, 5), [forms])
                ...
                <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-3">
                            <Checkbox checked={isSelected} onCheckedChange={() => toggleFormSelection(form.id)} />
                            <div className="flex-1">
                                <div className="flex items-center space-x-2 mb-1">
                                    ...
                                    {form.isRecommended && <Star className="w-4 h-4 text-yellow-500 fill-current" />}
                                    {form.isBookmarked && <Bookmark className="w-4 h-4 text-blue-500 fill-current" />}
                                </div>
                ...
                <CardContent className="pt-0">
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm text-gray-500">{form.completionPercentage}% complete</div>
                        </div>
    ...
    const renderFormList = (form: TaxForm) => {
        ...
        return (
            <div
                key={form.id}
                className={`flex items-center space-x-4 p-4 border rounded-lg transition-all hover:shadow-md ${isSelected ? 'ring-2 ring-primary' : ''}`}
            >
                <Checkbox checked={isSelected} onCheckedChange={() => toggleFormSelection(form.id)} />
                ...
                <div className="flex-1 grid grid-cols-6 gap-4 items-center">
                    ...
                    <div className="flex justify-end space-x-2">
                        ...
                        <Button size="sm" onClick={() => toast.success('Form generation started')}>
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Select, preview, and generate tax forms for your clients</p>
                </div>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                setFilters({
                                    ...
                                    year: 'all_years',
                                    complexity: 'all_levels',
                                    status: 'all_statuses',
                                    completionStatus: 'all_completion',
                                })
                            }
                        >
                            Clear All
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Button onClick={executeBatchOperation} disabled={batchOperation.isProcessing}>
